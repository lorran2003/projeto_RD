...
export function CarrosselGuarnicao() {
    return (

        <div className="w-full text-center">

            <div className="py-5">
                <h3 className="text-2xl after:block after:h-0.5 after:w-full after:bg-[#F20505] after:opacity-60 bg-zinc-900">Guarnição</h3>
            </div>
