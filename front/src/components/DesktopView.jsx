        ...
        <>
            <div className='flex'>
                ...
                <div className='relative w-2/3'>
                    ...
                    <div className='absolute flex flex-col gap-2 justify-center items-start top-8 '>
                        ...
                        <button className='dacingScript bg-[#3FE05C] text-zinc-50 p-2 rounded-r-md bottom-96 w-80 h-14 text-3xl' onClick={() => isOpenModal(pedido)}  >
                ...
                <div className='w-1/3 px-2 flex items-center'>
                    <p className='text-justify roboto-light p-5 bg-zinc-800 rounded overflow-visible relative right-14 shadow-sm shadow-zinc-950 text-xl'>
            ...
            <div className='flex flex-col h-full w-full'>
                ...
                <div className='w-1/3 px-2 flex items-center z-10'>
                    <p className='text-justify roboto-light p-5 bg-zinc-800 rounded overflow-visible relative left-14 shadow-sm shadow-zinc-950 text-xl'>
                    ...
                    <div className='w-2/3 relative'>
                        ...
                        <div className='flex flex-col justify-center items-end gap-2 right-0 absolute top-8'>
                            ...
                            <button className='dacingScript bg-[#3FE05C] text-zinc-50 p-2 rounded-l-md w-80 h-14 text-3xl' onClick={() => isOpenModal(pedido)} >
